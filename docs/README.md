# Narrata Documentation

| Document | What it covers |
|----------|----------------|
| [spec.md](./spec.md) | Mission, goals, non-goals, use cases, and MVP requirements. |
| [architecture.md](./architecture.md) | System boundary, runtime flow, components, and scope guardrails. |
...
| [operations.md](./operations.md) | Concurrency, logging, input hardening, and privacy. |
